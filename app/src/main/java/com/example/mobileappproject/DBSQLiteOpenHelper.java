...
public class DBSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public boolean insertData(String name, String discription, int hour, int minute, int month, int day, int year, boolean notify, boolean complete){
